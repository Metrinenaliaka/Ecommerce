...
router.post('/chatbot', async (req, res) => {
    try {
        ...
        console.log("Extracted Product IDs:", purchasedProducts);
        ...
        console.log("Retrieved Products with Embeddings:", pastEmbeddings);
...
Here are the top recommended products:

${productDescriptions}

DO NOT invent products or recommend anything outside this list.
If no relevant products are found, inform the admin to manually check for alternatives.`;
